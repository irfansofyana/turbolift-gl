...
func validateFlags(closeFlag bool, updateDescriptionFlag bool) error {
	if !onlyOne(closeFlag, updateDescriptionFlag) {
		return errors.New("update-mrs needs one and only one action flag")
	}
	return nil
}
